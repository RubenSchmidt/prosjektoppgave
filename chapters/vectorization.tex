...
\begin{figure}[H]
	...
	\captionsource{Mesh pattern line extraction. (a) image and mesh, (b) mesh pattern labels and control map, (c) lines extracted by analyzing the control map.}{\citeauthor{Wenyin1999}\cite{Wenyin1999}}
...
\begin{figure}[H]
	...
	\captionsource{Orthagonal Zig-Zag}{\citeauthor{Wenyin1999}\cite{Wenyin1999}}
	\label{fig:zigzag}
\end{figure}